...
public class Hangman {
  ...
  /**
   * Constructor of Hangman that assigns important values
   */
  public Hangman() {
    ...
    // hides the secret word by stars
  ...
  /**
   * This method is used to choose a secret word for the user to guess.
   * It chooses the secret word from a file wich has 500 words in it.
   * @return String, the secret word that was randomly chosen from the txt file
   */ 
