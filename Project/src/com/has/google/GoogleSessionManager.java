...
public class GoogleSessionManager
{
   ...
   static final String SCOPE = "email https://www.googleapis.com/auth/drive https://www.googleapis.com/auth/drive.file https://www.googleapis.com/auth/drive.metadata";
   public static final String AUTH_URL = "https://accounts.google.com/o/oauth2/v2/auth?scope=" + SCOPE + "&response_type=" + RESPONSE_TYPE + "&redirect_uri=" + REDIRECT_URI + "&client_id=" + CLIENT_ID;
